...
public class DeduplicatedPublicationSinkProvider implements SinkProvider<Publication>{
    ...
    public Sink<Publication> createSink() {
        return KafkaSink.<Publication>builder()
                ...
                .setRecordSerializer(KafkaRecordSerializationSchema.<Publication>builder()
                        .setTopic(kafkaProperties.getTopics().getDeduplicatedPublicationTopic())
